...
public class BonusSpawner : MonoBehaviourPun, IPunObservable
{
    ...
    void Update()
    {
        if (photonView.IsMine)
        {
            if (spawned)
            {
                ...
                {
                    bonuses[i].SetActive(i == currWeapon);
                }
            }
            else
            {
        ...
        if (other.GetComponent<Player>() != null)
        {
            if (other.GetComponent<Player>().photonView.IsMine)
            {
                if (spawned)
                {
                    ...
                    if (currWeapon == 0)
                    {
                        pl.GetComponent<Player>().playerHp += 45;
                    }
                    if (currWeapon == 1)
                    {
                        pl.GetComponent<Player>().playerArmor += 50;
                    }
                    if (currWeapon == 2)
                    {
                        pl.GetComponent<Player>().playerHp += 200;
                    }
                    if (currWeapon == 3)
                    {
                        pl.GetComponent<Player>().playerArmor += 200;
                    }
